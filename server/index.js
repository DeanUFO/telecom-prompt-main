...
app.post('/api/aggregate', async (req, res) => {
  ...
  try {
    ...
    if (process.env.AZURE_OPENAI_KEY && process.env.AZURE_OPENAI_ENDPOINT) {
      console.log('📞 Calling Copilot (Azure OpenAI) API...');
      try {
      ...
      console.log('⏭️  Skipping Copilot (no Azure OpenAI credentials)');
    }
...
// 新端點：生成 NotebookLM 格式的 Markdown 報告
app.post('/api/report/markdown', async (req, res) => {
  ...
  try {
    ...
    console.error('❌ Markdown report error:', err);
...
app.get('/api/models', (req, res) => {
  ...
  console.log('📡 Available models:', models.available.join(', '));
});
